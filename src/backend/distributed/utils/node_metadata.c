...
PG_FUNCTION_INFO_V1(get_distribution_value_shardid);
...
/*
 * get_distribution_value_shardid function takes a distributed table name and a
 ...
 */
Datum
get_distribution_value_shardid(PG_FUNCTION_ARGS)
{
