...
-- test get_distribution_value_shardid
...
3|3
\.
SELECT get_distribution_value_shardid('get_shardid_test_table1', 1);
SELECT get_distribution_value_shardid('get_shardid_test_table1', 2);
SELECT get_distribution_value_shardid('get_shardid_test_table1', 3);

-- verify result of the get_distribution_value_shardid
\c - - - :worker_1_port
...
SELECT get_distribution_value_shardid('get_shardid_test_table1', 4);
...
{d, e, f}|2
\.
SELECT get_distribution_value_shardid('get_shardid_test_table2', '{a, b, c}'::text[]);
SELECT get_distribution_value_shardid('get_shardid_test_table2', '{d, e, f}'::text[]);
...
SELECT get_distribution_value_shardid('get_shardid_test_table2', 'a'::text);

-- test non-distributed table
CREATE TABLE get_shardid_test_table3(column1 int, column2 int);
SELECT get_distribution_value_shardid('get_shardid_test_table3', 1);
